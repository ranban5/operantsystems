...
function chkRequiredFields_Comments(reqType)
{
    ...
    else if (reqType == "SkillsGraph")
    {
        ...
        if ( !($("#ctl00_ContentPlaceHolder_Master_chk_PCL").attr("checked")) && !($("#ctl00_ContentPlaceHolder_Master_chk_Header").attr("checked")))
        {
            strMessage += "<label class=\"requiredItem\">PCL or Header & Footer should be selected</label><br/>";        
        }
        else
        {
            if ( $("#ctl00_ContentPlaceHolder_Master_chk_PCL").attr("checked"))
            {
            ...
            else if ( $("#ctl00_ContentPlaceHolder_Master_chk_Header").attr("checked"))
            {
...
//        else if ( $("#ctl00_ContentPlaceHolder_Master_chk_Footer").attr("checked"))
//        {
...
//        }        
    ...
    else
    {
        ...
        //pls confirm that the date you have selected has a data point
            if ( $("#ctl00_ContentPlaceHolder_Master_chk_Header").attr("checked"))
            {
                $(".divRequireField").html(""); 
                return true;
            }
        ...
        $( ".add-button").click(                                        
                                ...
                                {                                       
                                    if ($(this).attr("title") == "Add Comments BG")
                                    {
                                        ...
                                        $("#ctl00_ContentPlaceHolder_Master_chkBehaviorGraph_VerticalLine").prop("checked", false);
                                        $("#ctl00_ContentPlaceHolder_Master_chkBehaviorGraph_VerticalLine").prop("checked", false);
                                        $("#ctl00_ContentPlaceHolder_Master_chkBehaviorGraph_Footnote").prop("checked", false);
                                    ...
                                    {
                                        $("#ctl00_ContentPlaceHolder_Master_txtBehaviorGraph_Id").val("");
...
//    function checkTv()
//    {
//        $("#ctl00_ContentPlaceHolder_Master_tvReportSkills").click(
//            
//            function()
//            {
//                alert(123);
...
function btnAccordion(btn)
{
        if ($(btn).attr("title") == "Add Comments BG")
        {
            ...
            $("#ctl00_ContentPlaceHolder_Master_txtBehaviorGraph_TextPosition").val("");
            $("#ctl00_ContentPlaceHolder_Master_chkBehaviorGraph_VerticalLine").prop("checked", false);
            $("#ctl00_ContentPlaceHolder_Master_chkBehaviorGraph_VerticalLine_Dash").prop("checked", false);
            $("#ctl00_ContentPlaceHolder_Master_chkBehaviorGraph_Footnote").prop("checked", false);
            $(".div_ChkBehaviorGraph input:checked").each(
                function()
                {
        ...
        {
            $("#ctl00_ContentPlaceHolder_Master_txtSkillsGraph_Text").val("");
            $("#ctl00_ContentPlaceHolder_Master_txtSkillsGraph_StartDate").val("");
            $("#ctl00_ContentPlaceHolder_Master_txtSkillsGraph_TextPosition").val("");
            $("#ctl00_ContentPlaceHolder_Master_chkSkillsGraph_VerticalLine").prop("checked", false);
            $("#ctl00_ContentPlaceHolder_Master_chkSkillsGraph_VerticalLine").prop("checked", false);
            $("#ctl00_ContentPlaceHolder_Master_chkSkillsGraph_Footnote").prop("checked", false);
            $(".tvSkillsGraph input:checked").prop("checked", false);
            $("#ctl00_ContentPlaceHolder_Master_butSkillsGraph_Save").attr('value','Save');
              if ($(btn).next().is(':hidden') == true)
                    $(btn).next().show();
              else
                    $(btn).next().hide();   
...
{
    if ($(chk)[0].id == "ctl00_ContentPlaceHolder_Master_chk_PCL")
    {
        $(".divSkillsGraph_form").show();
        $(".divSkillsGraph_form_HF").hide();
        
        $("#ctl00_ContentPlaceHolder_Master_chk_Header").removeAttr("checked");
        $("#ctl00_ContentPlaceHolder_Master_chk_Footer").removeAttr("checked");
    }
    else if ($(chk)[0].id == "ctl00_ContentPlaceHolder_Master_chk_Header")
    {
        ...
        $(".clsHeader").show();
         $(".clsFooter").show();
        $("#ctl00_ContentPlaceHolder_Master_chk_PCL").removeAttr("checked");
        $("#ctl00_ContentPlaceHolder_Master_chk_Footer").removeAttr("checked");        
    }    
    else if ($(chk)[0].id == "ctl00_ContentPlaceHolder_Master_chk_Footer")
    {
        $(".divSkillsGraph_form").hide();
        $(".divSkillsGraph_form_HF").show();
...
function chkSolidDash(chk, type)
{
    if ($(chk)[0].name == "ctl00$ContentPlaceHolder_Master$chkSkillsGraph_VerticalLine")
    {
        ...
        {
            document.getElementById('ctl00_ContentPlaceHolder_Master_chkSkillsGraph_VerticalLine_Dash').checked = false; 
            return; 
        }
    }
    else if ($(chk)[0].name == "ctl00$ContentPlaceHolder_Master$chkSkillsGraph_VerticalLine_Dash")
    {
        if ( $("#" + $(chk)[0].id).attr("checked"))
        {
            document.getElementById('ctl00_ContentPlaceHolder_Master_chkSkillsGraph_VerticalLine').checked = false;
            return;  
        }
    }   
    ...
    if (type == 'Solid')
    {
        if ($(chk).attr("checked"))
        {
            document.getElementById('ctl00_ContentPlaceHolder_Master_chkBehaviorGraph_VerticalLine_Dash').checked = false;  
        }
    }
    else if (type == 'Dash')
    {
        ...
        {
            document.getElementById('ctl00_ContentPlaceHolder_Master_chkBehaviorGraph_VerticalLine').checked = false;
        }
    }
}
...
function reportStartDate()
{
    ...
    {
        if ($("#ctl00_ContentPlaceHolder_Master_txtReportStartDate").val() != "")
        {
            var d = new Date($("#ctl00_ContentPlaceHolder_Master_txtReportStartDate").val());
            ...
            $("#ctl00_ContentPlaceHolder_Master_txtReportStartDate").val((d.getMonth()+1) + '/' + d.getDate() + '/' +  d.getFullYear());
            
            // to get the end date value add 7
            d.setDate(d.getDate() + 6);
            $("#ctl00_ContentPlaceHolder_Master_txtReportEndDate").val((d.getMonth()+1) + '/' + d.getDate() + '/' +  d.getFullYear());
        }
    }  
}
...
function reportEndDate()
{
    if ($(".txtClickType").val() == "Reports" && $(".ddReports :selected").val() == "StudentWeeklyProgramReviews")   
    {
        ...
        {
            var ed = new Date($("#ctl00_ContentPlaceHolder_Master_txtReportEndDate").val());
            var weekday=new Array(7);
            weekday[0]=4;
            weekday[1]=3;
            weekday[2]=2;
            ...
            $("#ctl00_ContentPlaceHolder_Master_txtReportEndDate").val((ed.getMonth()+1) + '/' + ed.getDate() + '/' +  ed.getFullYear());
 
            // to get the end date value minus 7
            ed.setDate(ed.getDate() - 6);
            $("#ctl00_ContentPlaceHolder_Master_txtReportStartDate").val((ed.getMonth()+1) + '/' + ed.getDate() + '/' +  ed.getFullYear());                        
        }
    }  
}
